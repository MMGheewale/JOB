                  ...
                  <tr>
                    <td><table width="100%" border="1" bordercolor="#1CB5F1" >
                      <tr>
                        ...
                        <th bgcolor="#1CB5F1" class="style3"><div align="left" class="style12">Qualification</div></th>
...
$sq=mysql_query("Select * from tblrequest where id='{$_GET['id']}' and emp='{$_SESSION['ID']}'");
if(mysql_num_rows($sq)>0){
    echo "Request already sent";
}else{
$result=mysql_query("insert into tblrequest values('{$_GET['id']}','{$_SESSION['ID']}','No')");
...
$i=0;
$res=  mysql_query("select * from tblrequest where id='$Id' and emp='{$_SESSION['ID']}' and status='Yes'");
...
?>
                      <tr>
                          ...
                          <td class="style3"><div align="left" class="style9 style5"><strong><?php echo $Qualification;?></strong></div></td>
                          <?php
                          if($i==0){
                              
                          ?>
                              <td class="style3"><div align="left" class="style9 style5"><strong><a href="ManageJob.php?id=<?php echo $Id;?>">Request</a></strong></div></td>
                          <?php
                          
                          }else{
                          ?>
                           <td class="style3"><div align="left" class="style9 style5"><strong><a href="DetailJob.php?JobId=<?php echo $Id;?>">View</a></strong></div></td>
                       <?php }
                       ?>
                      </tr>
                      <?php
