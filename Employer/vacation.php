...
if(isset($_REQUEST['button'])){
	...
	$sql = "insert into job_master (CompanyName,JobTitle,Vacancy,MinQualification,Description) values('".$_SESSION['Name']."','".$txtTitle."','".$txtTotal."','".$cmbQual."','".$txtDesc."')";
	// execute query
	mysql_query ($sql,$con);
	// Close The Connection
	mysql_close ($con);
	echo '<script type="text/javascript">alert("Vacancy Inserted Succesfully");window.location=\'vacation.php\';</script>';
}
?>
            <!-- Article -->
            <div class="article">
...
<!--                        <tr>
                  ...
                  <tr>
                    <td bgcolor="#A0B9F3"><strong>Posted Vacancy </strong></td>
                  </tr>
                  <tr>
                    <td></td>
                  </tr>
